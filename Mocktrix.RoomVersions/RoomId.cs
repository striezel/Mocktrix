...
{
    /// <summary>
    /// Contains utility functions for room ids.
    /// </summary>
    public static class RoomId
    {
        /// <summary>
        /// alphabet containing all possible characters for the "localpart" of room ids
        /// </summary>
        private static readonly string id_alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";


        /// <summary>
        /// Generates a random room id for a server with the given URI.
        /// </summary>
        /// <param name="server_uri">the server's URI</param>
        /// <returns>Returns a room id for the server.</returns>
