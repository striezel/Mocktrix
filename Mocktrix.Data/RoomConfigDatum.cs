...
namespace Mocktrix.Data
{
    ...
    public class RoomConfigDatum(string user_id, string room_id, string type, JsonNode data)
    {
        /// <summary>
        ...
        /// <summary>
        /// Id of the room where the configuration data is set, e.g. "!someRoom:matrix.example.org".
        /// </summary>
