...
{
    /// <summary>
    /// Contains tests for TopicEvent.
    /// </summary>
    public class TopicEventTests
    {
        [Fact]
        ...
        public void DeserializeSpecExample()
        {
            var json = """ 
                       ...
                       """;
            var ev = JsonSerializer.Deserialize<TopicEvent>(json);
        ...
        public void SerializeSpecExample()
        {
            ...
            var expected_json = "{\"content\":{\"topic\":\"A room topic\"},\"event_id\":\"$143273582443PhrSn:example.org\",\"origin_server_ts\":1432735824653,\"room_id\":\"!jEsUZKDJdhlrceRyVU:example.org\",\"sender\":\"@example:example.org\",\"state_key\":\"\",\"type\":\"m.room.topic\",\"unsigned\":{\"age\":1234}}";
        ...
        {
            Assert.True(new TopicEvent().IsStateEvent());
        }
    }
}
