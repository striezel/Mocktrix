    ...
    public class CreateRoomEventTests
    {
        ...
        public void DeserializeSpecExample()
        {
            var json = """ 
                       ...
                       """;
            var ev = JsonSerializer.Deserialize<CreateRoomEvent>(json);
        ...
        public void SerializeSpecExample()
        {
            var ev = new CreateRoomEvent
            {
                Content = new CreateRoomEventContent
                {
                    Creator = "@example:example.org",
                    Federate = true,
            ...
            var expected_json = "{\"content\":{\"creator\":\"@example:example.org\",\"m.federate\":true,\"predecessor\":{\"event_id\":\"$something:example.org\",\"room_id\":\"!oldroom:example.org\"},\"room_version\":\"1\"},\"event_id\":\"$143273582443PhrSn:example.org\",\"origin_server_ts\":1432735824653,\"room_id\":\"!jEsUZKDJdhlrceRyVU:example.org\",\"sender\":\"@example:example.org\",\"state_key\":\"\",\"type\":\"m.room.create\",\"unsigned\":{\"age\":1234}}";
        ...
        {
            Assert.True(new CreateRoomEvent().IsStateEvent());
        }
    }
}
