...
namespace Mocktrix.Events.Tests
{
    ...
    public class JoinRulesEventTests
    {
        ...
        public void Construction()
        {
            ...
            Assert.Null(ev.Content.JoinRule);
        ...
        public void DeserializeSpecExample()
        {
            var json = """ 
                       ...
                       """;
            var ev = JsonSerializer.Deserialize<JoinRulesEvent>(json);

            Assert.NotNull(ev);
            Assert.NotNull(ev.Content);
            Assert.Equal("public", ev.Content.JoinRule);
        ...
        public void SerializeSpecExample()
        {
            ...
            var expected_json = "{\"content\":{\"join_rule\":\"public\"},\"event_id\":\"$143273582443PhrSn:example.org\",\"origin_server_ts\":1432735824653,\"room_id\":\"!jEsUZKDJdhlrceRyVU:example.org\",\"sender\":\"@example:example.org\",\"state_key\":\"\",\"type\":\"m.room.join_rules\",\"unsigned\":{\"age\":1234}}";
        ...
        {
            Assert.True(new JoinRulesEvent().IsStateEvent());
        }
    }
}
