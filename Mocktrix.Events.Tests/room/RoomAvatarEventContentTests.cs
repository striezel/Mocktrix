...
{
    /// <summary>
    /// Contains tests for RoomAvatarEventContent.
    /// </summary>
    public class RoomAvatarEventContentTests
    {
        [Fact]
        public void Construction()
        {
            var content = new RoomAvatarEventContent();
        ...
        public void DeserializeSpecExample()
        {
            var json = """ 
                       ...
                       """;
            var content = JsonSerializer.Deserialize<RoomAvatarEventContent>(json);
        ...
        public void SerializeSpecExample()
        {
            ...
            var expected_json = "{\"info\":{\"h\":398,\"mimetype\":\"image/jpeg\",\"size\":31037,\"w\":394},\"url\":\"mxc://example.org/JWEIFJgwEIhweiWJE\"}";
