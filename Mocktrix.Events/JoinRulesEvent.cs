...
namespace Mocktrix.Events
{
    ...
    /// </summary>
    public class JoinRulesEvent: StateEventZeroLengthKey
    {
        ...
        public override IEventContent Content
        {
            ...
            set
            {
                if (value is JoinRulesEventContent content)
                {
                    _content = content;
                }
                else
        ...
        /// The event's content.
        /// </summary>
        private JoinRulesEventContent _content = new();
    }
